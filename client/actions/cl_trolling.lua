...
RegisterNetEvent('exter-adminmenu/client/fling-player', function()
    FlingPlayer()
end)

RegisterNetEvent("exter-adminmenu/client/drunk", function()
    drunkThread()
end)

RegisterNetEvent("exter-adminmenu/client/animal-attack", function()
    startWildAttack()
end)

RegisterNetEvent("exter-adminmenu/client/set-fire", function()
